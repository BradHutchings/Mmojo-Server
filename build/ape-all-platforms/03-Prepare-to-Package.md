...
echo
cd "$DEPLOY_DIR"
if ! find . -maxdepth 1 -type f,l -iname "EXAMPLE-*" -print -quit | grep -q .; then
    ...
    echo "Your APE files are now prepared for packaging."
else
    echo "Your APE files have already been prepared for packaging."
fi
cd "$HOME"
```
