...
Set the URL for the Mmojo Server package that runs on recent x86_64 CPUs, Apple M* Macs, and Raspberry Pi 5. It's unknown whether it runs on other vendoes' aarch64 (arm64) PCs.
```
URL=""
