...
---
### Requirements
This recipe deploys Mmojo Server on a single, stand-alone Raspberry Pi 5.
  - 4 GB RAM is workable with a 1B or 2B paramter model.
  - 8 GB RAM is workable with a 4B parameter model.
