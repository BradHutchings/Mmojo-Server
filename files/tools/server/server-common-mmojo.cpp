/*
  server-common-mmojo.cpp is a derivative for tools/server/server-common.cpp.
  ...
  Purpose:
      OAI /v1/chat/completions seems to be losing the "role" : "developer" message. Might be too aggressive converting it.
