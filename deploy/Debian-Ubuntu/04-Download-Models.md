...
**Optional:** Qwen3.5 models implement so-called "thinking" and "tool calling". Qwen3.5 models, particularly 9B, seem to be the best for coing small apps. Run this script to download them.
```
cat << EOF >> $_MODEL_QUEUE
