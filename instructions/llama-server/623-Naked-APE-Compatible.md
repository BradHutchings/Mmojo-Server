...
- Run the script.
  ```
  $MMOJO_SERVER_SCRIPTS/620-Add-UI-to-APE.sh compatible naked llama-server
  # Keep track of what we add for the args file.
...
- Run the script.
  ...
  if [ -v CHOSEN_MODEL ]; then
    $MMOJO_SERVER_SCRIPTS/620-Add-gguf-Model-to-APE.sh compatible naked llama-server
    # Keep track of what we add for the Args file.
