...
if [ $(uname -m) = "x86_64" ]; then
    ...
    # _BUILD_SUBDIR="$BUILD_DIR/$BUILD_SUBDIRECTORY_X86_64$_BUILD_CHOICE$_GPUS_CHOICE"
    # _PACKAGE_FILE="Mmojo-Server-macos-x86_64-native$_GPUS_CHOICE.zip"
    # _RPC_PACKAGE_FILE="Mmojo-RPC-Server-aarch64-rpi5.zip"
    # _TOUCH_FILE="$BUILD_SUBDIRECTORY_X86_64$_BUILD_CHOICE$_GPUS_CHOICE"
elif [ $(uname -m) = "aarch64" ] || [ $(uname -m) = "arm64" ]; then
    _BUILD_SUBDIR="$BUILD_DIR/$BUILD_SUBDIRECTORY_AARCH64$_BUILD_CHOICE$_GPUS_CHOICE"
    ...
    _TOUCH_FILE="$BUILD_SUBDIRECTORY_AARCH64$_BUILD_CHOICE$_GPUS_CHOICE"
fi
