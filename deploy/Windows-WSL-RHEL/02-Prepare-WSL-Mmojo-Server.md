...
**DRAFT IN PROGRESS. DOES NOT WORK YET.**
...
```
wsl --install FedoraLinux-43 --name MmojoServer-Fedora
```
...
```
export REPO_DIR="$HOME/mm-mmojo-server-repo"
