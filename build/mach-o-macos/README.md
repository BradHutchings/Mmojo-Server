...
***Note:** I am still sorting out what "compatible" and "performant" mean for CPUs in the macOS space. The concept is better tied to x86_64 CPUs. -Brad*

These build steps should be performed with macOS. Please prepare your macOS environment by working through this deploy recipes:
...
- [04. Package for macOS](04-Package-for-macOS.md) &mdash; Package your builds for macOS.
