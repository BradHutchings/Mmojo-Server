...
```
ln -sfr "$RUN_DIR/RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_PERFORMANT_FILE.exe" \
    "$RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_FILE"
```
```
ln -sfr "$RUN_DIR/RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_PERFORMANT_FILE" \
    "$RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_FILE"
```
```
ln -sfr "$RUN_DIR/RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_COMPATIBLE_FILE.exe" \
    "$RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_FILE"
```
```
ln -sfr "$RUN_DIR/RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_COMPATIBLE_FILE" \
    "$RUN_DIR/$PACKAGE_MMOJO_SERVER_APE_FILE"
```
