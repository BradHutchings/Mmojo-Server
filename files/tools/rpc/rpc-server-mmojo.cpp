/*
  rpc-server-mmojo.cpp is a derivative for tools/rpc/rpc-server.cpp.

  This file has been modified to implement Mmojo Server specific functionality.
  Modifications are surrounded by:
    // Mmojo Server START
    // Mmojo Server END
    
  Original rpc-server.cpp file:
