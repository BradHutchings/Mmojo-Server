...
export SHARE_MOUNT_POINT="/Volumes/mmojo"
else
export SHARE_MOUNT_POINT="/mnt/mmojo"
fi

export SHARE_CERTIFICATES_DIR="$SHARE_MOUNT_POINT/$CERTIFICATES_DIR_NAME"
export SHARE_MODELS_DIR="$SHARE_MOUNT_POINT/$MOOELS_DIR_NAME"
export SHARE_PACKAGES_DIR="$SHARE_MOUNT_POINT/$PACKAGES_DIR_NAME"
