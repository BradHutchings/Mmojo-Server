...
mm-build-for-platform.sh $_VARIATION "$_GPUS_CHOICE" "llama-server"
```
...
mm-build-for-platform.sh compatible "$_GPUS_CHOICE" "llama-server"
```
</details>
...
mm-build-for-platform.sh performant "$_GPUS_CHOICE" "llama-server"
```
</details>
